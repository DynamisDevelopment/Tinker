        ...
        <div class="col-span-12 xl:col-span-9 xxl:col-span-9 z-10">
          ...
          <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
            ...
            >
              ...
              <div class="text-theme-35 text-xs mt-5">
            ...
            >
              <div class="flex flex-wrap items-center">
                ...
                <select
                  class="
                    ...
                    text-white
                    dark:bg-transparent
                    dark:border-opacity-100 dark:border-dark-5
                    mx-auto
                    sm:mx-0
                    py-1.5
                    px-3
              ...
              <div class="mt-12 text-xs text-gray-300 dark:text-gray-500">
              ...
              <div class="flex items-center justify-center mt-10">
                ...
                <div
                  class="
                    w-px
                    h-16
                    border border-r border-dashed border-theme-28
                    dark:border-dark-5
                    mx-4
                    xl:mx-6
                  "
